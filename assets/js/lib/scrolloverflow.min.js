 ...
 */
 !(function (r, n, p) {
			...
			(e.getTime =
				...
				(e.momentum = function (t, i, s, e, o, n) {
					var r,
						...
						a = t - i,
						l = p.abs(a) / s;
					return (h = l / (n = void 0 === n ? 6e-4 : n)), (r = t + ((l * l) / (2 * n)) * (a < 0 ? -1 : 1)) < e ? ((r = o ? e - (o / 2.5) * (l / 8) : e), (h = (a = p.abs(r - t)) / l)) : 0 < r && ((r = o ? (o / 2.5) * (l / 8) : 0), (h = (a = p.abs(t) + r) / l)), { destination: p.round(r), duration: h };
				});
			var s = t('transform');
			return (
	...
	function t(t, i) {
		for (var s in ((this.wrapper = 'string' == typeof t ? n.querySelector(t) : t), (this.scroller = this.wrapper.children[0]), (this.scrollerStyle = this.scroller.style), (this.options = { resizeScrollbars: !0, mouseWheelSpeed: 20, snapThreshold: 0.334, disablePointer: !m.hasPointer, disableTouch: m.hasPointer || !m.hasTouch, disableMouse: m.hasPointer || m.hasTouch, startX: 0, startY: 0, scrollY: !0, directionLockThreshold: 5, momentum: !0, bounce: !0, bounceTime: 600, bounceEasing: '', preventDefault: !0, preventDefaultException: { tagName: /^(INPUT|TEXTAREA|BUTTON|SELECT|LABEL)$/ }, HWCompositing: !0, useTransition: !0, useTransform: !0, bindToWrapper: void 0 === r.onmousedown }), i)) this.options[s] = i[s];
	...
	function a(t, i) {
		for (var s in ((this.wrapper = 'string' == typeof i.el ? n.querySelector(i.el) : i.el), (this.wrapperStyle = this.wrapper.style), (this.indicator = this.wrapper.children[0]), (this.indicatorStyle = this.indicator.style), (this.scroller = t), (this.options = { listenX: !0, listenY: !0, interactive: !1, resize: !0, defaultScrollbars: !1, shrink: !1, fade: !1, speedRatioX: 0, speedRatioY: 0 }), i)) this.options[s] = i[s];
	...
	(t.prototype = {
		...
		_initIndicators: function () {
			var t,
				...
				e = [],
				o = this;
			(this.indicators = []), this.options.scrollbars && (this.options.scrollY && ((t = { el: h('v', i, this.options.scrollbars), interactive: i, defaultScrollbars: !0, customStyle: s, resize: this.options.resizeScrollbars, shrink: this.options.shrinkScrollbars, fade: this.options.fadeScrollbars, listenX: !1 }), this.wrapper.appendChild(t.el), e.push(t)), this.options.scrollX && ((t = { el: h('h', i, this.options.scrollbars), interactive: i, defaultScrollbars: !0, customStyle: s, resize: this.options.resizeScrollbars, shrink: this.options.shrinkScrollbars, fade: this.options.fadeScrollbars, listenY: !1 }), this.wrapper.appendChild(t.el), e.push(t))), this.options.indicators && (e = e.concat(this.options.indicators));
			...
			(this.currentPage = {}),
				...
				this.on('refresh', function () {
					...
					if (((this.pages = []), this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight)) {
						...
						else for (t = (n = this.options.snap).length, i = -1; r < t; r++) (0 === r || n[r].offsetLeft <= n[r - 1].offsetLeft) && ((h = 0), i++), this.pages[h] || (this.pages[h] = []), (a = p.max(-n[r].offsetLeft, this.maxScrollX)), (o = p.max(-n[r].offsetTop, this.maxScrollY)), (s = a - p.round(n[r].offsetWidth / 2)), (e = o - p.round(n[r].offsetHeight / 2)), (this.pages[h][i] = { x: a, y: o, width: n[r].offsetWidth, height: n[r].offsetHeight, cx: s, cy: e }), a > this.maxScrollX && h++;
		...
		_key: function (t) {
			if (this.enabled) {
				var i,
					...
					n = m.getTime(),
					r = this.keyTime || 0;
				switch ((this.options.useTransition && this.isInTransition && ((i = this.getComputedPosition()), this._translate(p.round(i.x), p.round(i.y)), (this.isInTransition = !1)), (this.keyAcceleration = n - r < 200 ? p.min(this.keyAcceleration + 0.25, 50) : 0), t.keyCode)) {
